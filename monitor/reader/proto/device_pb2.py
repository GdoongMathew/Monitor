...
MemoryInfo = _reflection.GeneratedProtocolMessageType(
    "MemoryInfo",
    (_message.Message,),
    {
...
MatrixInfo = _reflection.GeneratedProtocolMessageType(
    "MatrixInfo",
    (_message.Message,),
    {
...
NVGPU = _reflection.GeneratedProtocolMessageType(
    "NVGPU",
    (_message.Message,),
    {
        "DESCRIPTOR": _NVGPU,
...
NVGPUArray = _reflection.GeneratedProtocolMessageType(
    "NVGPUArray",
    (_message.Message,),
    {
...
CPU = _reflection.GeneratedProtocolMessageType(
    "CPU",
    (_message.Message,),
    {
        "DESCRIPTOR": _CPU,
